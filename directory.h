...
private:
	int size = 10;
	shared_ptr<int[]> ptr{ new int[size] };//Я понял зачем нужны умные указатели, но в моей программе изначально не выделялась динамическая память, поэтому мне сейчас негде их использовать
